...
public:
  ...
  CUresult invoke(CUdeviceptr input,
    ...
    // These correspond exactly to the 16 arguments in the
    // compiler-generated bare-pointer GPU ABI after specializing
    // tid / 8 and tid % 8 to shift/mask operations.
    int64_t arg_block_size = THREADS;
    int64_t arg_total_outputs = total_outputs_;

    int64_t arg_shift_amount = 3;
    int64_t arg_output_mask = 7;

    float arg_one_f = 1.0f;
    float arg_inv_h = 2.5f;

    int32_t arg_zero_i32 = 0;
    int32_t arg_four_i32 = 4;
    ...
    void *kernel_args[] = {
        &arg_block_size,        // param 0
        &arg_total_outputs,     // param 1
        &arg_shift_amount,      // param 2
        &arg_output_mask,       // param 3
        &arg_input,             // param 4

        &arg_one_f,             // param 5
        &arg_inv_h,             // param 6
        &arg_zero_i32,          // param 7
        &arg_four_i32,          // param 8
