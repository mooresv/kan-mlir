...
extern "C" MLIR_CUDA_WRAPPERS_EXPORT void mgpuModuleUnload(CUmodule module) {
  // Called from a generated global destructor. At process shutdown the
  // CUDA primary-context machinery may already have been destroyed.
  // The process is exiting, so the CUDA driver/OS will reclaim the module.
  (void)module;
}
